...
export default function F4FPage() {
  ...
  return (
    <div style={{ background: '#000', color: '#fff', minHeight: '100vh', padding: '30px 40px', fontFamily: 'system-ui' }}>
      ...
      {/* Sources (Mucche) table */}
      <div style={{ marginBottom: 12, fontSize: 12, color: '#666' }}>Mucche</div>
      ...
      <div style={{ marginTop: 40, padding: 16, background: '#111', fontSize: 11, color: '#666', lineHeight: 1.5 }}>
        <strong style={{ color: '#888' }}>Note:</strong> The {stats.totalFollowing || 0} users in the DB were imported from sync.
        New follows will save the source account automatically.
        Sync checks for follow backs every 6 hours.
      </div>
    </div>
  );
}
