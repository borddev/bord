        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            ...
            <div>
              ...
              <div style={{ color: '#666', fontSize: 12 }}>@username</div>
            </div>
        ...
        {selectedTool && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <a
                href={`vscode://file/${process.cwd?.() || '.'}/${selectedTool.path}`}
                style={{ color: '#1d9bf0', fontSize: 11, textDecoration: 'none' }}
              >
                {selectedTool.path}
              </a>
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 20, padding: 12, background: '#0a0a0a', borderRadius: 6 }}>
              ...
              <a
                href={`vscode://file/./${agentConfig.filePath}`}
                style={{ color: '#1d9bf0', fontSize: 12, textDecoration: 'none' }}
              >
